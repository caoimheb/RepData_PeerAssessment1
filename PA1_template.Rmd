...
The mean and median of the total number of steps taken per day, as calculated in the above code, are `r mean_steps` and `r median_steps`, respectively. 
...
The interval with the max number of steps, as calculated above, is `r average_per_interval.max`.
